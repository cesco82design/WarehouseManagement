...
$scheda = new Scheda();
$clienti = new Cliente();
$key = $clienti->pulisci_stringa($_POST['ricerca']);
/*echo $key;
$res=$clienti->search($_GET['search'],$key);
print_r($res);
*/
...
<header>
  <div class="continer">
    <div class="row">
      <div class="col-xs-12">
        <h1 class="text-center">Risultati della ricerca per : <?php echo $_GET['search']; ?></h1>
      </div>
    </div>
    <div class="row">
  ...
  <div class="container">
     <div class="table-responsive">
      <table class="table table-hover">
        ...
        <?php
        if  ($res=$clienti->search($_GET['search'],$key)) {
